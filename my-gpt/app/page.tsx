    ...
    <div className="flex min-h-screen flex-col bg-neutral-800 text-white">
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-8">
        ...
        <div className="w-full max-w-3xl">
          <Card className="rounded-2xl border-neutral-800 bg-neutral-700 py-[-1]">
            <CardContent className="p-0">
              <div className="relative">
                <Textarea
                  placeholder="Ask anything"
                  className="max-h-[200px] min-h-[40px] w-full resize-none border-none bg-transparent px-4 pt-4  pb-10 text-base leading-relaxed text-white placeholder-gray-400 outline-none focus-visible:ring-0"
                  style={{
                    scrollbarWidth: 'none',
                ...
                <div className="absolute bottom-3 left-3 flex items-center space-x-2">
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-8 w-8 text-gray-400 hover:text-gray-200 hover:bg-neutral-600 rounded-full"
                  >
