    ...
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          size="sm"
          className="h-6 w-6 flex-shrink-0 p-0 opacity-0 group-hover:opacity-100 hover:bg-neutral-600"
          onClick={(e) => {
            e.preventDefault()
            e.stopPropagation()
            setIsOpen((prev) => !prev)
      ...
      >
        ...
        <DropdownMenuItem className="cursor-pointer text-red-400 hover:bg-neutral-600 hover:text-red-300 focus:bg-neutral-600 focus:text-red-300">
