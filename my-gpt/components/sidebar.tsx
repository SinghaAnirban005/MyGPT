...
import { Edit, MessageSquare, PanelLeft, PanelRight, Search, Library, MoreHorizontal, Archive, Trash2, Edit3, Share } from 'lucide-react'
    ...
    return (
      ...
      >
        <div className="flex h-14 items-center justify-between px-3">
          ...
          {!collapsed && <Skeleton className="h-6 w-6 rounded" />}
        </div>
        
        <div className="px-2 pb-2">
          <Skeleton className={cn("h-10 rounded-lg", collapsed ? "w-12" : "w-full")} />
        </div>
        
        <div className="flex-1 px-2 space-y-1">
          {Array.from({ length: 5 }).map((_, i) => (
            <Skeleton key={i} className={cn("h-10 rounded-lg", collapsed ? "w-12" : "w-full")} />
          ))}
        </div>
        
        <div className="p-2">
          <Skeleton className={cn("h-12 rounded-lg", collapsed ? "w-12" : "w-full")} />
        </div>
      </div>
    )
  }
        ...
        <div className="flex items-center">
          <Tooltip>
            <TooltipTrigger asChild>
              <div
                className="flex h-8 w-8 cursor-pointer items-center justify-center rounded-lg hover:bg-neutral-700 relative"
              ...
              >
                {collapsed && isLogoHovered ? (
                  ...
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6">
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              size="sm"
              className={cn(
                'h-9 w-full justify-start text-white hover:bg-neutral-700',
                collapsed ? 'justify-left px-0' : 'px-3'
              )}
            >
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            ...
            >
              ...
              {!collapsed && <span className="ml-2">Search chats</span>}
            </Button>
          </TooltipTrigger>
