...
import { Edit, MessageSquare, PanelLeft, PanelRight, Search, Library, MoreHorizontal, Archive, Trash2, Edit3, Share, Menu, X } from 'lucide-react'
      ...
      >
        ...
        <div className="flex-1 px-2 space-y-1">
          {Array.from({ length: 5 }).map((_, i) => (
            <Skeleton key={i} className={cn("h-10 rounded-lg", (collapsed && !isMobile) ? "w-12" : "w-full")} />
          ))}
        </div>
